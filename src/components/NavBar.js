...
{/* NAV BAR COMPUTER */}
      ...
      <nav className="flex items-center justify-center flex-wrap gap-6">
        ...
        <motion.a
          href="https://www.linkedin.com/in/taimoor-zulfiqar-1ba913317?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3B9uZYTedTQHmyyGFFo%2FIS%2Fw%3D%3D"
          target={"_blank"}
          whileHover={{ y: -2 }}
          whileTap={{ scale: 0.9 }}
          className="w-6"
